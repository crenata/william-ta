...
<img src="{{ asset("about.jpg") }}" alt="Logo" width="100%" height="500">
    <div class="container">
        ...
        <h5 class="mt-3 mb-0">Motto Kami :</h5>
        <p class="mt-1 mb-0">Selalu memberi yang terbaik bagi Customer kami, yaitu memproduksi produk berkualitas dengan desain terkini serta pelayanan yang prima. Kami hadir untuk memenuhi harapan serta impian customer kami menjadi kenyataan dalam mewujudkan rumah idaman.</p>
    </div>
@endsection
