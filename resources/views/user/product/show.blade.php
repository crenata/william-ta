    ...
    <div class="row">
        ...
        <div class="col-12 col-md-3">
            ...
            <div class="mt-2">
                ...
                <h4 class="m-0 fw-semibold {{ !empty($product->is_gold) ? "text-decoration-line-through" : (empty($product->offer_price) ? "d-none" : "") }}">Offer Price : Rp{{ number_format($product->offer_price) }}</h4>
