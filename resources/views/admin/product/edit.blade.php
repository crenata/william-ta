...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-6 offset-md-3">
            <h3 class="text-center fw-bold">{{ __("Edit Product") }}</h3>
                ...
                <form method="POST" action="{{ route("product.update", $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <input
                            ...
                            name="duration_type"
                            value="{{ old("duration_type", $product->duration_type) }}"
                            required
                    ...
                    <div class="mt-3">
                        ...
                        <input
                            ...
                            name="start_price"
                            value="{{ old("start_price", $product->start_price) }}"
                            required
                    ...
                    <div class="mt-3">
                        ...
                        <input
                            ...
                            name="end_price"
                            value="{{ old("end_price", $product->end_price) }}"
                            required
