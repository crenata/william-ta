...
<div class="container">
    <div class="">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <h4 class="">{{ __("Manage Material") }}</h4>
            <a class="btn btn-sm btn-success" href="{{ route("material.create") }}">
                {{ __("Add") }}
            </a>
        </div>
        ...
        <div class="table-responsive mt-4" style="height: 75vh;">
            <table class="table">
                ...
                @foreach($materials as $material)
                    <tr>
                        <td valign="middle">{{ $material->name }}</td>
                        <td valign="middle" class="text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="{{ route("material.edit", $material->id) }}">{{ __("Edit") }}</a></li>
