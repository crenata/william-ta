...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-6 offset-md-3">
            <h3 class="text-center fw-bold">{{ __("Edit Color") }}</h3>
                    ...
                    <div class="">
                        ...
                        >
                            ...
                            @foreach($materials as $material)
                                <option value="{{ $material->id }}" {{ $material->id === old("material_id", $color->material_id) ? "selected" : "" }}>{{ $material->name }}</option>
                            @endforeach
                        </select>
                        @error("material_id")
